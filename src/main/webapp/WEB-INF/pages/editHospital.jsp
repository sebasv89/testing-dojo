...
<body>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Testing Dojo <small> Editar hospital</small>
						</h1>
						<!--                         <ol class="breadcrumb"> -->
						<!--                             <li class="active"> -->
				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						<p> (esto si le toca
							llenarlo a sebas :P)...select anidados (con delay), el segundo delay carga a los 3 segundos y a los 3.5 segundos se selecciona el valor que es</p>
					</div>
				</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label for="name">Nombre completo<span
									...
									class="form-control"
									placeholder="Ingrese el nombre" value="${hospital.name}">
							</div>
							<div class="form-group">
								<label for="address">Direcci&oacute;n<span
									class="text-danger">*</span></label> <input type="text"
									class="form-control"
									placeholder="Ingrese los apellidos" value="${hospital.address}">
							</div>
							<div class="form-group">
								<label for="telephone">Tel&eacute;fono </label> <input
									type="text" class="form-control" placeholder="Ingrese el tel&eacute;fono" value="${hospital.telephone}">
							</div>
							<div class="form-group">
							...
							<input id="input_department" type="hidden" value="${hospital.department}" />
							<input id="input_municipality" type="hidden" value="${hospital.municipality}" />
	...
	<script src="../resources/js/app/edit-hospital.js" charset="UTF-8"></script>
