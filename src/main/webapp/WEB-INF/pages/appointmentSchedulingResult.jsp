					...
					<div class="col-md-4">
						<table class="table table-bordered table-striped">
							<tbody>
								...
								<tr>
									<td><strong>Identificacion del doctor:</strong></td>
									<td>${appointment.doctorsIdentification}</td>
								</tr>
								<tr>
								...
								<tr>
									<td><strong>Identificacion del paciente:</strong></td>
									<td>${appointment.patientsIdentification}</td>
								</tr>
								<tr>
